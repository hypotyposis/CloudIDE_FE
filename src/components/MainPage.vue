...
<div class="ide-canvas">
    ...
    <div class="editor-top-bar" style="width:100%;height:auto;float:left;display: flex;flex-direction: row;">
        ...
        <el-select size="mini" v-model="language" placeholder="请选择" @change="onLanguageChange">
            <el-option
    ...
    <div id="container" style="width:100%;height:70%">
        <div ref="monacoEditor" style="width:60%;height:100%;float:left;"></div>
        <div id="terminal" ref="terminal" style="width:40%;height:100%;float:left;"></div>
        ...
        <div id="input-container" style="width:40%;height:30%;float:left;">
            <div ref="cinEditor" style="width:100%;height:100%;float:left;"></div>
        </div>
        <div id="output-container" style="width:40%;height:30%;float:left;">
            <div ref="coutEditor" style="width:100%;height:100%;float:left;"></div>
        </div>
        <div id="performancePanel" style="width:20%;height:30%;float:left;">
...
export default {
    ...
    methods: {
        onLanguageChange() {
            console.log(this.language, typeof(this.language));
        ...
        submit(){
            ...
            this.coutEditor.setValue("编译运行中...")
            let url = "/api/code/"
            var _this = this
            // var timestamp = Date.parse(new Date())
            var timestamp = (new Date()).valueOf()
            console.log(timestamp)
            this.$axios.post(url, {code: codeValue, cin: cinValue, timestamp: timestamp, language: language})
            .then(function(res){
                console.log(res)
    ...
    mounted() {
        ...
        // this.performancePanel = new Chart(ctx, {
        //     type: "line",
        //     data: {
        //         datasets:[{
        //             data: [12, 19, 3, 5, 2, 3],
        ...
        let terminal = new Terminal({
            ...
            // rows: parseInt(40), //行数
            // cols: parseInt(40), // 不指定行数，自动回车后光标从下一行开始
